...
export default function HomeCardItem({lehanga}){
    return (
      ...
      <div className="w-full h-full object-cover object-top">
        <img
          ...
          src={lehanga.imageUrl || "https://images.pexels.com/photos/842811/pexels-photo-842811.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"}
          alt=""
        />
      </div>
      <div className="truncate text-lg text-center p-3 font-semibold text-slate-700">{lehanga.title}</div>
      <div className="p-3">
